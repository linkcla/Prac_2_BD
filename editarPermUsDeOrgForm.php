    ...
    <section>
        <div class="container">
            <form id="formulari" action="editarOrg.php" method="post">
                ...
                <button type="button" class="btn btn-primary mt-3" id="botcrearG" name="action" value="delete">Crear un grup</button>
            </form>
            <script>
            const form = document.getElementById('formulari');
            const realitzarCaviG = document.getElementById('botRealitzarCaviG');
            const botcrearG = document.getElementById('botcrearG');
            ...
            botcrearG.addEventListener('click', function() {
                form.action = 'crearGrupForm.php';
                form.submit();
