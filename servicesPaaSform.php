    ...
    <section class="about_section layout_paddingAbout">
        ...
        <div class="container">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="precio_ram">Precio de RAM</label>
                    <input type="text" name="precio_ram" id="precio_ram" class="form-control" value="<?php echo $precioRam; ?>" readonly>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="precio_disc_dur">Precio de DISC DUR</label>
                    <input type="text" name="precio_disc_dur" id="precio_disc_dur" class="form-control" value="<?php echo $precioDiscDur; ?>" readonly>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="precio_cpu">Precio de CPU</label>
                    <input type="text" name="precio_cpu" id="precio_cpu" class="form-control" value="<?php echo $precioCpu; ?>" readonly>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="precio_so">Precio de Sistema Operativo</label>
                    <input type="text" name="precio_so" id="precio_so" class="form-control" value="<?php echo $precioSo; ?>" readonly>
                </div>
            </fieldset>
